                ...
                case 1: // Add Grade
                    ...
                    if (assignAll == 'Y') {
                        ...
                        for (String subj : defaultSubjects) {
                            ...
                            String insertGrade = "INSERT INTO grades (s_id, sbj_id, final) " +
                                                 "SELECT ?, sbj_id, ? FROM subjects WHERE sbj_desc = ?";
                            db.addRecord(insertGrade, sId, grade, subj);
                        ...
                        do {
                            ...
                            System.out.print("\nAdd another subject for this student? (Y/N): ");
